...
public class ServiceProviderDetails {
    ...
    @Column(nullable = false)
    private Double budget; // Change from Integer to Double

    @Column(nullable = false)
    private Double avgRating = 0.0;  // Default value 0.0

    @Column(nullable = false)
    private Integer numberOfRatings = 0;  // Default value 0

    @Column(nullable = false)
    private Integer socialService = 0;  // Make sure this is Integer, not int
